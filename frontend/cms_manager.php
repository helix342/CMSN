                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="managerapproveForm">
                                    ...
                                    <label for="deadline" class="fw-bold">Set Deadline:</label>
                                    <input type="date" id="deadline01" name="deadline" class="form-control mb-3">

                                    <label class="fw-bold">Set Priority:</label>
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" form="managerapproveForm">Submit</button>
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
